            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a class="navbar-brand" href="dashboard.php"><img src="assets/images/Logo.png" alt="" height="56"></a>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul
                                    ...
                                    <li><a href="change-password.php"><i class="ti-settings m-r-5"></i> Chnage
                                            Password</a></li>
