...
$status=1;
$query=mysqli_query($con,"insert into tblposts(PostTitle,CategoryId,PostDetails,Creator,PostUrl,Is_Active,PostImage) values('$posttitle','$catid','$postdetails','$Creator','$url','$status','$imgnewfile')");
if($query)
{
                                    ...
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <input type="text" class="form-control" id="creator" name="creator"
                                                placeholder="Enter Penulis Name" required>
                                        </div>
